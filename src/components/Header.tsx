...
interface HeaderProps {
  ...
  activeTab: 'alerts' | 'network' | 'poison' | 'probe' | 'trackers' | 'harvest-matrix' | 'inspector' | 'pulse' | 'entropy';
  setActiveTab: (tab: 'alerts' | 'network' | 'poison' | 'probe' | 'trackers' | 'harvest-matrix' | 'inspector' | 'pulse' | 'entropy') => void;
}
...
export const Header: React.FC<HeaderProps> = ({
  ...
  interface NavItem {
    id: 'alerts' | 'network' | 'poison' | 'probe' | 'trackers' | 'harvest-matrix' | 'inspector' | 'pulse' | 'entropy';
    label: string;
    badge?: string | null;
